    ...
    <div className="board-result">
      ...
      <div className="stats-grid">
        <div className="stat-box">
          <span className="stat-val" style={{ color: cfg.color }}>{result.person_count}</span>
          <span className="stat-key">Est. Passengers</span>
        </div>
        <div className="stat-box">
          <span className="stat-val" style={{ color: cfg.color }}>{result.occupancy_ratio}%</span>
          <span className="stat-key">Seat Occupancy</span>
        </div>
        <div className="stat-box">
      ...
      {result.density_label && (
        <div className="density-strip" style={{ borderColor: cfg.color + "55" }}>
          <span className="density-item">
            <span className="density-key">YOLO Detected</span>
            <span className="density-val">{result.raw_detected ?? result.person_count} people</span>
          </span>
          <span className="density-sep">·</span>
          <span className="density-item">
            <span className="density-key">Frame Coverage</span>
            <span className="density-val">{result.coverage_pct}%</span>
          </span>
          <span className="density-sep">·</span>
          <span className="density-item">
            <span className="density-key">Crowd Density</span>
            <span className="density-val" style={{ color: cfg.color, textTransform: "uppercase", fontWeight: 700 }}>
              {result.density_label}
            </span>
          </span>
        </div>
      ...
      <div className="threshold-guide">
        <span className="tg-label">Status Thresholds (seats filled):</span>
        <div className="tg-row">
          <span className="tg-dot" style={{ background: "#00C853" }} />
          <span className="tg-text">🟢 GREEN: 0–{Math.floor(result.seated_capacity * 0.50)} people</span>
        </div>
        <div className="tg-row">
          <span className="tg-dot" style={{ background: "#FF6D00" }} />
          <span className="tg-text">🟠 ORANGE: {Math.floor(result.seated_capacity * 0.50) + 1}–{Math.floor(result.seated_capacity * 0.85)} people</span>
        </div>
        <div className="tg-row">
          <span className="tg-dot" style={{ background: "#D50000" }} />
          <span className="tg-text">🔴 RED: {Math.floor(result.seated_capacity * 0.85) + 1}+ people</span>
        </div>
      </div>
